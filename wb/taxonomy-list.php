...
if(isset($wbArgs['page']) && $wbArgs['page'] > 1){
	$prevUrl = $wb['wb_url'].'/' . $type . '/'. $cat .'/page/'.$wpArgs['page'];
}

if( $remaining > 0 ){
	$nextURL = $wb['wb_url'].'/' . $type . '/'. $cat .'/page/'.($wpArgs['page'] + 1 );
}
...
<div id="page-taxonomy" class="container">
	<h2><?php echo $cat;?></h2>
	<div class="blurb"><?php echo __("Find great activities &amp; adventures for your dream vacation in ",'arez').__($cat,'arez');?></div>
